<section class="quote-section">
    <div class="quote-form-wrapper">
        ...
        <div class="quote-form-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/quote.png" alt="Happy couple" width="840" height="720"style="max-width:100%; height:auto;" />
        </div>
    </div>
</section>