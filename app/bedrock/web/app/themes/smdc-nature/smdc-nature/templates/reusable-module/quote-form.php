  ...
  <input type="hidden" name="quote_form_title" value="<?php echo esc_attr( get_the_title( get_queried_object_id() ) ); ?>">
    ...
    <div class="form-group select-wrapper">
      ...
      <span class="select-arrow">
        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="#000000" viewBox="0 0 256 256"><path d="M216.49,104.49l-80,80a12,12,0,0,1-17,0l-80-80a12,12,0,0,1,17-17L128,159l71.51-71.52a12,12,0,0,1,17,17Z"></path></svg>
      </span>
    </div>
      ...
      <div class="form-group select-wrapper">
        ...
        <span class="select-arrow">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" viewBox="0 0 256 256"><path d="M216.49,104.49l-80,80a12,12,0,0,1-17,0l-80-80a12,12,0,0,1,17-17L128,159l71.51-71.52a12,12,0,0,1,17,17Z"></path></svg>
      </div>
